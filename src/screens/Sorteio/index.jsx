...
export function Sorteio() {
    ...
    function SorteioPote1(pote) {
        ...
        while (pote.length > 0) {
            ...
            switch (nroGrupo) {
                case 2: grupoB.push(pote[sorteio]); break;
                case 3: grupoC.push(pote[sorteio]); break;
                case 4: grupoD.push(pote[sorteio]); break;
                case 5: grupoE.push(pote[sorteio]); break;
                case 6: grupoF.push(pote[sorteio]); break;
                case 7: grupoG.push(pote[sorteio]); break;
                case 8: grupoH.push(pote[sorteio]); break;
            }
        ...
        while (pote.length > 0) {
            ...
            switch (nroGrupo) {
                ...
                case 2:
                    ...
                    grupoB.push(pote[sorteio]); break;
                case 3:
                    while (!podeInserir) {
                        sorteio = (Math.floor(Math.random() * pote.length));
                        paisSorteado = pote[sorteio];
                    ...
                    grupoC.push(pote[sorteio]); break;
                case 4:
                    ...
                    grupoD.push(pote[sorteio]); break;
                case 5:
                    while (!podeInserir) {
                        sorteio = (Math.floor(Math.random() * pote.length));
                        paisSorteado = pote[sorteio];
                    ...
                    grupoE.push(pote[sorteio]); break;
                case 6:
                    while (!podeInserir) {
                        sorteio = (Math.floor(Math.random() * pote.length));
                        paisSorteado = pote[sorteio];
                    ...
                    grupoF.push(pote[sorteio]); break;
                case 7:
                    while (!podeInserir) {
                        sorteio = (Math.floor(Math.random() * pote.length));
                        paisSorteado = pote[sorteio];
                    ...
                    grupoG.push(pote[sorteio]); break;
                case 8:
                    while (!podeInserir) {
                        sorteio = (Math.floor(Math.random() * pote.length));
                        paisSorteado = pote[sorteio];
                    ...
                    grupoH.push(pote[sorteio]); break;
            }
    ...
    function InserirGrupo(pGrupo, pPaisSorteado) {
        ...
        for (let i = 0; i < pGrupo.length; i++) {
            if (pGrupo[i].continente == pPaisSorteado.continente) {
                ...
                if (qtdPaisMesmoConinenteNoGrupo == limiteMaxContinente)
                    return false;
